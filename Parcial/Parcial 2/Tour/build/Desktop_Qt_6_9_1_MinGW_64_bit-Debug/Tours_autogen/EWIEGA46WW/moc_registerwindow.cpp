...
#include "../../../../../../Parcial_2/Tour/registerwindow.h"
...
template <> constexpr inline auto RegisterWindow::qt_create_metaobjectdata<qt_meta_tag_ZN14RegisterWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "RegisterWindow",
        "on_registerConfirmButton_clicked",
        ""
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_registerConfirmButton_clicked'
...
void RegisterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_registerConfirmButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
